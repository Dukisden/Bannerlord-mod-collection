    ...
    public class MCMSettings : AttributeGlobalSettings<MCMSettings>
    {
        ...
        // Damage
            ...
            public bool EnableArmorAmplify { get; set; } = false;
                ...
                [SettingPropertyFloatingInteger("Reduced armor efficacy vs Blunt", 0f, 1f, "#0%", Order = 1, RequireRestart = false, HintText = "0% = no change, 100% = armor has no effect vs blunt damage")]
                [SettingPropertyGroup("Damage Modifiers/Amplify armor effect")]
                public float BluntMult { get; set; } = 0.2f;

                [SettingPropertyFloatingInteger("Extra Axe damage vs Shields", 0f, 2f, "#0%", Order = 1, RequireRestart = false, HintText = "0% = no change, 100% = Shields take 2 times more damage from axes")]
                [SettingPropertyGroup("Damage Modifiers/Amplify armor effect")]
            ...
            [SettingPropertyGroup("Damage Modifiers/Damage Multipliers")]
            public bool EnableDamageMults { get; set; } = false;

                [SettingPropertyFloatingInteger("Player Damage Received", 0f, 2f, "#0%", Order = 10, RequireRestart = false, HintText = "Adjusts the damage received by the player. 100% = no change")]
                [SettingPropertyGroup("Damage Modifiers/Damage Multipliers")]
                public float DamageMultiplierPlayer { get; set; } = 1f;

                [SettingPropertyFloatingInteger("Player Family Damage Received", 0f, 2f, "#0%", Order = 20, RequireRestart = false, HintText = "Adjusts the damage received by the player’s clan members. 100% = no change")]
                [SettingPropertyGroup("Damage Modifiers/Damage Multipliers")]
                public float DamageMultiplierFamily { get; set; } = 1f;

                [SettingPropertyFloatingInteger("Player Clan Damage Received", 0f, 2f, "#0%", Order = 30, RequireRestart = false, HintText = "Adjusts the damage received by the player’s clan members. 100% = no change")]
                [SettingPropertyGroup("Damage Modifiers/Damage Multipliers")]
                public float DamageMultiplierClan { get; set; } = 1f;

                [SettingPropertyFloatingInteger("Player Troops Damage Received", 0f, 2f, "#0%", Order = 40, RequireRestart = false, HintText = "Adjusts the damage received by the player’s regular troops. 100% = no change")]
                [SettingPropertyGroup("Damage Modifiers/Damage Multipliers")]
                public float DamageMultiplierPlayerTroops { get; set; } = 1f;

                [SettingPropertyFloatingInteger("AI Lords Damage Received", 0f, 2f, "#0%", Order = 50, RequireRestart = false, HintText = "Adjusts the damage received by AI lords. 100% = no change")]
                [SettingPropertyGroup("Damage Modifiers/Damage Multipliers")]
                public float DamageMultiplierAILords { get; set; } = 1f;

                [SettingPropertyFloatingInteger("AI Troops Damage Received", 0f, 2f, "#0%", Order = 60, RequireRestart = false, HintText = "Adjusts the damage received by AI troops. 100% = no change")]
                [SettingPropertyGroup("Damage Modifiers/Damage Multipliers")]
                public float DamageMultiplierAITroops { get; set; } = 1f;

                [SettingPropertyFloatingInteger("Player Formation Damage Received", 0f, 1f, "#0%", Order = 70, RequireRestart = false, HintText = "Damage received by your heroes (not player) when their formation has over 15 units left. Applies on top of other applicable multipliers.")]
                [SettingPropertyGroup("Damage Modifiers/Damage Multipliers")]
                public float DamageMultiplierFormation { get; set; } = 0.5f;

                [SettingPropertyFloatingInteger("Ai Formation Damage Received", 0f, 1f, "#0%", Order = 80, RequireRestart = false, HintText = "Damage received by Ai heroes when their formation has over 15 units left. Applies on top of other applicable multipliers.")]
                [SettingPropertyGroup("Damage Modifiers/Damage Multipliers")]
                public float DamageMultiplierAiFormation { get; set; } = 1f;

                [SettingPropertyFloatingInteger("Bodyguards Damage Received", 0f, 1f, "#0%", Order = 90, RequireRestart = false, HintText = "Damage received by bodyguards (for Ai lords & player with bodyguard mod.) Applies on top of other applicable multipliers.")]
                [SettingPropertyGroup("Damage Modifiers/Damage Multipliers")]
