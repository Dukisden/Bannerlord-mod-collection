using DukisCollection.dk_Leader;
...
namespace DukisCollection
{
    public class MCMSettings : AttributeGlobalSettings<MCMSettings>
    {
        ...
        [SettingPropertyBool("Enable Amplify Armor Effect", Order = 0, IsToggle = true, HintText = "When enabled, blunt damage is less affected by armor. Cut damage is more affected by armor. Axes do more damage to shields.", RequireRestart = false)]
            ...
            // Damage multipliers
            [SettingPropertyBool("Enable Damage Multipliers", Order = 0, IsToggle = true)]
